...
class AuthView(View):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        ).order_by("auth_method__priority")
    ...
    def get(self, request, *args, **kwargs):
        ...
        # if CAS or OIDC is enabled, redirect to the appropriate view
        if cas_enabled:
            cas_auth_view = CASAuthView()
            return cas_auth_view.cas_login()
        elif oidc_enabled:
            oidc_auth_view = OIDCAuthView()
            return oidc_auth_view.oidc_login()
