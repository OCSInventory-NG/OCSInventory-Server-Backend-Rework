...
def create_default_fields(apps, schema_editor):
    fields = [
        ...
        {
            "name": "Date Last Logged User",
            "retrival_value": "DATELASTLOGGEDUSER",
            "override_target": False,
            "new_target": None,
            "retrival_method": None,
            "retrival_output": None,
