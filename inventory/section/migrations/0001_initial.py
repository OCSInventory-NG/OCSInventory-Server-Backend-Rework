...
def create_default_sections(apps, schema_editor):
    sections = [
        ...
        },
        {
            ...
            "retrival_method": "PW",
            "retrival_output": "JSON",
            "target": "Get-WmiObject -ClassName Win32_PhysicalMemory -Property * | ConvertTo-Json",
            "options": {"need_format": False},
            "template": apps.get_model("template", "Template").objects.get(os="WIN"),
        },
        {
            ...
            "retrival_method": "PW",
            "retrival_output": "JSON",
            "target": "Get-WmiObject -className Win32_LogicalDisk -Property * | ConvertTo-Json",
            "options": {"need_format": False},
            "template": apps.get_model("template", "Template").objects.get(os="WIN"),
        },
        {
        ...
        },
        {
            ...
            "retrival_method": "PW",
            "retrival_output": "JSON",
            "target": "Get-NetAdapter | ConvertTo-Json",
            "options": {"need_format": False},
            "template": apps.get_model("template", "Template").objects.get(os="WIN"),
        },
        {
        ...
        },
        {
            ...
            "retrival_method": "PW",
            "retrival_output": "JSON",
            "target": "netsh wlan show interfaces | ConvertTo-Json",
            "options": {"need_format": False},
            "template": apps.get_model("template", "Template").objects.get(os="WIN"),
        },
        {
