...
class SnmpConfig(models.Model):
    ...
    auth_level = models.CharField(max_length=128, choices=AUTH_LEVELS, blank=True)
    password = models.CharField(max_length=128, blank=True)
    auth_protocol = models.CharField(max_length=4, choices=AUTH_PROTOCOLS, blank=True)
    priv_protocol = models.CharField(max_length=4, choices=PRIV_PROTOCOLS, blank=True)
    priv_password = models.CharField(max_length=128, blank=True)
